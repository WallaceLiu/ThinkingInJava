...
// {Args: 5}
package bdata.cap.com.concurrency.restaurant2;

import bdata.cap.com.enumerated.menu.Food;
...
class Customer implements Runnable {
    ...
    public void run() {
        for (bdata.cap.com.enumerated.menu.Course course : bdata.cap.com.enumerated.menu.Course.values()) {
