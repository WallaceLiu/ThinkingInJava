...
import mindview.atunit.TestObjectCleanup;
import mindview.atunit.TestObjectCreate;
import mindview.atunit.TestProperty;
...
public class AtUnitExample5 {
    ...
    public static void main(String[] args) throws Exception {
        OSExecute.command("java mindview.atunit.AtUnit AtUnitExample5");
    }
} /* Output:
